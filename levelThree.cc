...
void LevelThree::movePiece(std::vector<Piece *> pieces, std::vector<std::vector<Cell>> &theBoard, char playerColour)
{
        // level one
    bool moveMade = false;
...
bool LevelThree::capturePiece(std::vector<Piece *> pieces, std::vector<std::vector<Cell>> &theBoard, char playerColour)
{
...
bool LevelThree::canBeCaptured(int rOld, int cOld, std::vector<std::vector<Cell>> &theBoard, char playerColour)
{
...
bool LevelThree::avoidCapture(std::vector<Piece *> pieces, std::vector<std::vector<Cell>> &theBoard, char playerColour)
{
    for(int i = 0; i < pieces.size(); ++i)
    {
         int rOld = pieces[i]->getCell(theBoard).getInfo().row;
...
void LevelThree::makeMove(std::vector<Piece *> pieces, std::vector<std::vector<Cell>> &theBoard, char playerColour)
{
